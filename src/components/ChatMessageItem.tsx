...
import { MoreVertical, Quote as QuoteIcon, Star, AlertCircle, HelpCircle, MessageCircle, Lightbulb, BookOpen, User as UserIcon, MessageSquare, Clock, Check } from 'lucide-react-native';
